...
const TemplateSix = () => {
  return (
    <div className="w-[1080px] h-[1080px] relative bg-[#143A6D]">
      {/* heading title  */}
      <div className="w-[728px] [215px] ml-[179px] mr-[180px] pt-[40px] ">
        <h1 className="font-bold text-[#FFF] text-[58px] uppercase leading-[63px] tracking-[2.9px] font-popins">
          Transform Your Future with the Digital World Today
        </h1>
      </div>

      {/* image masking  */}
      <section className="mt-[22px] mx-[109px]">
        <div className="w-[860px] h-[484px] rounded-[40px] bg-[#D9D9D9] overflow-hidden">
          <img
            className="w-full h-full object-cover"
            src="https://img.freepik.com/premium-photo/real-estate-advertisement-design_1230717-166658.jpg?w=740"
            alt=""
          />
        </div>
      </section>
      ...
      {/* content  */}
      <section className="w-full h-[238px] bg-[#FFFFFF] absolute bottom-0">
        <div className="w-[860px] h-[119px] mx-[110px] mt-[22px]">
        ...
        <div className="flex items-center gap-x-[43px] ml-[37px] mr-[23px] mt-[4px]">
          {/* contact Information  */}
          ...
          {/* booking button  */}
          <button className="bg-[#02224D] font-popins text-[32px] font-normal w-[232px] h-[68px] rounded-full text-white ">
            Book Now
          </button>
      ...
      <svg
        className="absolute top-[78px] right-[55px]"
        xmlns="http://www.w3.org/2000/svg"
        width="94"
        height="768"
        viewBox="0 0 94 768"
        fill="none"
      >
        <path d="M0 1H93V767.5" stroke="white" stroke-width="2" />
      </svg>

      <svg
        className="absolute top-[78px] left-[55px]"
        xmlns="http://www.w3.org/2000/svg"
        width="96"
        height="766"
        viewBox="0 0 96 766"
        fill="none"
      >
        <path d="M96 1H1V765.5" stroke="white" stroke-width="2" />
      </svg>
    </div>
  );
};
