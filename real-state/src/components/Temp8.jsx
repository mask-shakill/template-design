...
const Temp8 = () => {
  return (
    <div className="h-[400px] w-[400px] relative bg-[#DBDBDB]">
      {/* shapes  */}
      <svg
        width="400"
        height="400"
      ...
      >
        <path
          d="M25.1211 359.076L374.878 359.998"
          stroke="#002E6B"
          stroke-width="2"
          stroke-linecap="round"
        />
        <path
          d="M0 0H400V136.667L198.519 228.889L0 135.741V0Z"
          fill="#002E6B"
        />
        <rect y="385.926" width="400" height="14.0741" fill="#002E6B" />
      </svg>

      {/* image masking  */}
      <div className="w-[350px] h-[196px] bg-slate-300 absolute top-[47px] overflow-hidden right-[24px]">
        <img
      ...
      >
        <path
          d="M2.97559 46.25H360.092"
          stroke="#FFAA2A"
          stroke-width="5"
          stroke-linecap="round"
        />
        <path
          d="M10.6104 244.645V3.28459"
          stroke="#FFAA2A"
          stroke-width="5"
          stroke-linecap="round"
        />
      ...
      <svg
        className="absolute left-[35px] bottom-[70px]"
        xmlns="http://www.w3.org/2000/svg"
        width="133"
        height="130"
        viewBox="0 0 133 130"
      ...
      >
        <path
          d="M0.555664 0H132.408V106.078L66.2964 129.259L0.555664 106.263V0Z"
          fill="#002E6B"
        />
      </svg>

      {/* content  */}
      <div className="absolute top-[249px] right-5 ">
        {/* heading  */}
        <div className="w-[193px] break-words h-[60px]    ">
          <h1
            style={{
              fontFamily: "Poppins",
              fontWeight: "700",
            ...
            className="uppercase  font-semibold text-[#002E6B] text-[13px] leading-[14px]"
          >
        ...
        {/* sub-heading  */}
        <div className="w-[193px] h-[38px]  mt-1    font-normal">
          <h1
            style={{ fontFamily: "Poppins", fontWeight: "400" }}
            className=" text-[9.5px] break-words leading-[12px] text-[#000000]"
          >
      ...
      {/* information  */}
      <div className="w-[125px] absolute bottom-[16px] left-[30px]  mt-1 flex items-center gap-x-[5px] ">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="10"
          height="16"
      ...
      {/* email */}
      <div className="flex gap-x-1  absolute bottom-[19px] right-[30px] ">
        <svg
          className="order-1"
          xmlns="http://www.w3.org/2000/svg"
          width="14"
      ...
      <div
        className="absolute bottom-[124px] flex items-center justify-center
       left-[86.7px] w-[34px] h-[30px]"
      >
        <h1
          className="uppercase text-[#FFFFFF] text-[30px]"
          style={{ fontFamily: "Poppins", fontWeight: "500" }}
        >
          Book now
        </h1>
      ...
      {/* brand name and logo  */}
      <div className="flex items-center overflow-hidden absolute top-4 left-[28px] gap-x-2">
